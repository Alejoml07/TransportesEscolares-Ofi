...
urlpatterns = [
    ...
    path('listarBeneficiarioCli/', views.listarBeneficiarioCli, name = "listarBeneficiarioCli"),
    ...
    path('registrarComentarios/<int:id>', views.registrarComentarios, name = "registrarComentarios"),
    ...
    path('registrarPeticiones/<int:id>', views.registrarPeticiones, name = "registrarPeticiones"),
